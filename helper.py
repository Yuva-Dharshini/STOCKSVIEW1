...
def line_plot(data , column , color, width=800, height=400):
...
def Overview_all(data , title , drop=False, width=800, height=400) : 
    if drop == True:
...
def Histplot(data , columns , title, width=800, height=400) : 
...
def drawdown_plot(data, width=800, height=400) : 
    fig = go.Figure()
...
def plot_with_dropdown(data, tickers, width=800, height=400):
...
def plot_daily_returns_dropdown(data, tickers, width=800, height=400):
...
def risk_plot(rets, width=800, height=400) : 
...
def candle_plot(df,ticker=None, multi=False, width=800, height=400) :
...
def predictions_plot(data_train , val, width=800, height=400) : 
    fig = go.Figure()
